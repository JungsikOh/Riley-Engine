...
inline DXBlendStateDesc OpaqueBlendStateDesc() {
    ...
    desc.render_target[0].src_blend = desc.render_target[0].src_blend_alpha =
        DXBlend::One;
    desc.render_target[0].dest_blend = desc.render_target[0].dest_blend_alpha =
        DXBlend::Zero;
    desc.render_target[0].blend_op = desc.render_target[0].blend_op_alpha =
        DXBlendOp::Add;
